...
public class GreatWoodBlock extends EvkyModElements.ModElement {
	@ObjectHolder("evky:great_wood")
	public static final Block block = null;
	public GreatWoodBlock(EvkyModElements instance) {
		super(instance, 10);
	}

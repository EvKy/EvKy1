...
public class GreatStairsBlock extends EvkyModElements.ModElement {
	@ObjectHolder("evky:great_stairs")
	public static final Block block = null;
	public GreatStairsBlock(EvkyModElements instance) {
		super(instance, 14);
	}

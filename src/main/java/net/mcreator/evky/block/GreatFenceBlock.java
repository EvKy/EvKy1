...
public class GreatFenceBlock extends EvkyModElements.ModElement {
	@ObjectHolder("evky:great_fence")
	public static final Block block = null;
	public GreatFenceBlock(EvkyModElements instance) {
		super(instance, 16);
	}

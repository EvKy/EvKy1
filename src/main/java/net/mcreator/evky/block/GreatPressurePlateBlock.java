...
public class GreatPressurePlateBlock extends EvkyModElements.ModElement {
	@ObjectHolder("evky:great_pressure_plate")
	public static final Block block = null;
	public GreatPressurePlateBlock(EvkyModElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("great_pressure_plate");
		}
